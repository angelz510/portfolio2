  ...
  return (
    <div className='about'>
      ...
      <p className='about-description'>
        <p>Originally from Mexico 🇲🇽 and raised in the Bay Area. Enjoy building applications
        ...
        <br/>
        <br/>In the past, I've built applications using Node.js, React (and Redux), Django, MERN, Express.
        <p>Before development I worked in community, career coaching system-involved youth in San Francisco.</p>
        <br/>When I'm not coding I'm exploring Hyrule or home spraying my plants.
      </p>
    </div>
  );
};
